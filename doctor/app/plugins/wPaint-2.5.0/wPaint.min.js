function fillcollor_black(bnp){
	if(bnp == 'text'){
		if($.fn.wPaint != undefined){
			$('#wPaint').wPaint('fillStyle', '#000000');
		}
	}else if(bnp == 'rectangle' || bnp == 'ellipse'){
		if($.fn.wPaint != undefined){
			$('#wPaint').wPaint('fillStyle', 'rgba(100, 100, 100, 0)');
		}
	}else if(bnp == 'more'){
		if($.fn.wPaint != undefined){
			if($(".wPaint-menu-icon-name-rectangle").hasClass('hide')){
				$(".wPaint-menu-icon-name-rectangle").removeClass('hide');
				$(".wPaint-menu-icon-name-ellipse").removeClass('hide');
				$(".wPaint-menu-icon-name-line").removeClass('hide');
				$(".wPaint-menu-icon-name-bucket").removeClass('hide');
				$(".wPaint-menu-icon-name-fillStyle").removeClass('hide');
				$(".wPaint-menu-icon-name-lineWidth").removeClass('hide');
				$(".wPaint-menu-icon-name-strokeStyle").removeClass('hide');
				$(".wPaint-menu-icon-name-more").attr('title','Less');
			} else {
				...
				$(".wPaint-menu-icon-name-more").attr('title','More');
			}
		}
	}
}
$("body").on("mouseover", ".wPaint-menu-icon", function(){
	var tooltip_class = '';
	if($(this).hasClass('wPaint-menu-icon-name-undo'))
		tooltip_class = 'wPaint-menu-icon-name-undo';
	else if($(this).hasClass('wPaint-menu-icon-name-redo'))
		tooltip_class = 'wPaint-menu-icon-name-redo';
	else if($(this).hasClass('wPaint-menu-icon-name-clear'))
		tooltip_class = 'wPaint-menu-icon-name-clear';
	else if($(this).hasClass('wPaint-menu-icon-name-pencil'))
		tooltip_class = 'wPaint-menu-icon-name-pencil';
	else if($(this).hasClass('wPaint-menu-icon-name-text'))
		tooltip_class = 'wPaint-menu-icon-name-text';
	else if($(this).hasClass('wPaint-menu-icon-name-eraser'))
		tooltip_class = 'wPaint-menu-icon-name-eraser';
	else if($(this).hasClass('wPaint-menu-icon-name-more'))
		tooltip_class = 'wPaint-menu-icon-name-more';
	else if($(this).hasClass('wPaint-menu-icon-name-bucket'))
		tooltip_class = 'wPaint-menu-icon-name-bucket';
	else if($(this).hasClass('wPaint-menu-icon-name-fillStyle'))
		tooltip_class = 'wPaint-menu-icon-name-fillStyle';
	else if($(this).hasClass('wPaint-menu-icon-name-lineWidth'))
		tooltip_class = 'wPaint-menu-icon-name-lineWidth';
	else if($(this).hasClass('wPaint-menu-icon-name-strokeStyle'))
		tooltip_class = 'wPaint-menu-icon-name-strokeStyle';
	else if($(this).hasClass('wPaint-menu-icon-name-rectangle'))
		tooltip_class = 'wPaint-menu-icon-name-rectangle';
	else if($(this).hasClass('wPaint-menu-icon-name-ellipse'))
		tooltip_class = 'wPaint-menu-icon-name-ellipse';
	else if($(this).hasClass('wPaint-menu-icon-name-line'))
		tooltip_class = 'wPaint-menu-icon-name-line';
	else if($(this).hasClass('wPaint-menu-icon-name-save'))
		tooltip_class = 'wPaint-menu-icon-name-save';
	else if($(this).hasClass('wPaint-menu-icon-name-bold'))
		tooltip_class = 'wPaint-menu-icon-name-bold';
	else if($(this).hasClass('wPaint-menu-icon-name-italic'))
		tooltip_class = 'wPaint-menu-icon-name-italic';
	else if($(this).hasClass('wPaint-menu-icon-name-fontSize'))
		tooltip_class = 'wPaint-menu-icon-name-fontSize';
	else if($(this).hasClass('wPaint-menu-icon-name-fontFamily'))
		tooltip_class = 'wPaint-menu-icon-name-fontFamily';
    if(tooltip_class != '') {
