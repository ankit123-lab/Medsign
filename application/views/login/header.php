...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <script type="text/javascript">
            ...
            var home_url = '<?= HOME_PATH; ?>';
            var login_url = '<?= LOGIN_PATH; ?>';
            var common_url = '<?= COMMON_PATH; ?>';
                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse" id="my_navbar">
                        <ul class="nav navbar-nav hidden-xs">
                            <li><a href="<?= DOMAIN_URL ?>"><img src="<?php echo ASSETS_PATH; ?>/images/logo.png" class="img-responsive site_logo m_top_10" /></a></li>
                        </ul>
                        <ul class="main_navigation">
                            <li class="navigation_li">
                                <a href="javascript:void(0)" class="active font_color_3"><?= lang("header_home") ?></a>
                            </li>
                            <li class="navigation_li">
                                <a href="<?= DASHBOARD_PATH ?>about-us" class="font_color_3">
                                    <?= lang("header_about_us") ?>
                                </a>
                            </li>
                            <li class="navigation_li">
                                <a href="javascript:void(0)" class="font_color_3">
                                    <?= lang("header_plan") ?>
                                </a>
                            </li>
                            <li class="navigation_li">
                                <a href="<?= DASHBOARD_PATH ?>contact-us" class="font_color_3">
                                    <?= lang("header_contact_us") ?>
                                </a>
                            </li>
                            <li class="float_right m_top_22 text_decoration_none nav navbar-nav white_color"> 
                                <a class="background_color_1 white_color text_decoration_none" href="#" id="login_register_button">
                                    <?= lang("header_login") ?> / <?= lang("header_register") ?>
                                </a>
                            </li>
                        </ul>
                    </div>
