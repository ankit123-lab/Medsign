        ...
        <?php if (!empty($billing_data)) { ?>
            <div>
                ...
                <div class="width_50 pull_left text_right">
                    <p class="no_margin">Date: <b><?php echo get_display_date_time('d/m/Y', $billing_data[0]['billing_invoice_date']); ?></b></p>
                    <p class="no_margin">Invoice Number: <b><?= $billing_data[0]['invoice_number']; ?></b></p>
                </div>
            </div>
            <div>
            ...
            <div class="bill_container" style="margin-top: 50px;">
                <div class="pull_left" style="width: 60%">
                    ...
                    <table class="custom_table text_center"> 
                        ...
                        <tr class="heading">
                            <td><?php echo get_display_date_time('d/m/Y', $billing_data[0]['billing_invoice_date']); ?></td>
