...
$lang['common_councils_found'] = "Councils found succesfully.";
$lang['common_councils_not_found'] = "Councils not found.";
$lang['user_caregiver_message'] = "%s has added you as caregiver. You will have access to all health related information of %s available on Medeasy Mobile Application";
...
$lang['not_able_to_cancel'] = "You can't able to cancel the appointment before 1 hour";
...
$lang['appointment_book_patient'] = "Appointment booked successfully for %s with %s at %s on %s ";
$lang['appointment_cancel'] = "Appointment cancelled successfully for %s with %s at %s on %s ";
$lang['appointment_cancel_message'] = "Appointment cancel succesfully";
$lang['appointment_reschedule'] = "Appointment reschedule successfully for %s with %s at %s on %s ";
$lang['appointment_reschedule_message'] = "Your appointment has been rescheduled";
$lang['emergency_message'] = "%s has added your number as an emergency phone number in Medeasy Mobile Application";
$lang['added_family_member'] = "%s has added you as family member in Medeasy Mobile Application";
...
$lang['appointment_alreay_taken'] = "Reschedule denied because you are already entered some details in appointment";
