...
$lang['user_login_token_generate_error'] = "Unable to process request please try again."; //"Error in generate access token";
$lang['invalid_otp_for_login'] = "Incorrect OTP, %s attempts remaining."; //"You have entered an incorrect OTP.There are only %s attempts remain to enter the correct OTP.";
$lang['failure'] = "Unable to process request please try again."; //"Something went wrong";
...
$lang['resetpassword_reset_empty']   = "Unable to process request please try again.";  //"Direct access not allowed";
$lang['resetpassword_reset_success'] = "Password reset successful !";
$lang['resetpassword_reset_fail'] = "Password reset unsuccessful. Please try again or contact Support !";//"Problem while reset password";
...
$lang['sms_otp_send_fail'] = "Unable to process request please try again."; //"Problem in sending OTP through text message. Please try again";
$lang['mobile_number_not_register_with_us'] = "Invalid login credentials please try again"; //"Mobile Number is not reigstered with us. Please try again";
...
$lang['user_register_phone_number_exist_but_not_verified'] = "Invalid login credentials please try again"; //"User is already registered but phone number is not verified";
$lang['user_register_phone_number_already_verfied'] = "This mobile number is registered & verified."; //"This phone number is already verified";
...
$lang['user_register_email_exist_but_not_verified'] = "Email is register but not verified. Please verify."; //"User is already registered but email is not verified";
...
$lang['otp_verfication_limit_reach'] = "Incorrect OTP"; //"You have reached OTP verification limit. Please try again using resend OTP.";
$lang['otp_resend_limit_reach'] 	 = "You have reached OTP resend limit. Please contact MedSign support team";
$lang['otp_resend_time_limit'] 		 = "You need to wait for %s seconds for resend OTP.";

$lang['user_register_fail'] = "Unable to process request please try again."; //"Error while registering user.";
$lang['otp_sent_to_mobile'] = "Please verify OTP sent to the given number."; //"OTP sent to given phone number. Please verify";

$lang['user_not_found'] = "User details not found. Please try again.";
$lang['user_register_success'] = "Registration successful !";//"Registration done successfully.";
$lang['user_profile_update_success'] = "Profile updated successfully !"; //"User profile updated successfully.";
...
$lang['user_logout_success'] = "You have logged out successfully !";//"User is successfully logged out";
$lang['user_logout_fail'] = "Unable to process request please try again.";//"Error while  logging out";
...
$lang['user_forgotpassword_success'] = "An email with password reset instuctions has been sent to your registered email address."; //"Password reset instruction email send to your registered email address";
$lang['user_forgotpassword_fail'] = "Invalid login credintials please try again."; //"This email address is not registered with us";
...
//drug languages
$lang['drug_add'] = "Medicine added successfully !"; //"Medicine added succesfully";
$lang['drug_add_failure'] = "Unable to process request please try again."; //"Error while adding medicine";
$lang['drug_already_added'] = "This medicine is already exists !"; //"This medicine is already added";
...
$lang['not_able_to_cancel'] = "You cannot cancel the appointment now.";
$lang['not_able_to_reschedule'] = "You cannot reschedule the appointment now. Please book a new one.";
$lang['appointment_reschedule'] = "Appointment has been rescheduled";

$lang['patient_added'] = "Patient added successfully";
$lang['patient_edited'] = "Patient details updated succesfully";
$lang['patient_dob_updated'] = "Patient DOB updated successfully";
...
$lang['prescription_added'] = "Prescription saved succesfully";
...
$lang['reminder_notification']    		 = "You have an reminder"; //N
...
$lang['appointment_cancel_patient']      = "Dear %s , Your appointment with %s at %s on %s is cancelled. Please rebook your appointment. Team MedSign! 
Visit- %s 
Email- %s";//SMS/N
$lang['appointment_cancel_when_doc_change_calendar_patient'] = "Dear %s , Your appointment with %s at %s on %s is cancelled. Please rebook your appointment. Team MedSign! 
Visit- %s 
Email- %s";//SMS/N
$lang['appointment_cancel_when_doc_change_calendar_doctor']  = "Dear %s your appointment with %s at %s on %s is cancelled.";//SMS/N
$lang['appointment_reschedule'] 		 = "Dear %s your appointment with %s at %s on %s is rescheduled.";//SMS/N
$lang['appointment_reschedule_patient']  = "Dear %s, Your appointment with %s at %s is rescheduled. The new appointment date and time is %s. Team MedSign! 
Visit- %s 
Email- %s";//SMS/N
$lang['share_patient_detail'] 			 = "Dear %s, Your digital prescription generated by %s through MedSign health platform has been shared by %s. This is for your information.";//SMS/N
$lang['template_33_share_patient_detail'] = "Dear %s, Your digital prescription generated by %s through MedSign health platform has been shared by %s. This is for your information.";//SMS/N
...
$lang['appointment_reschedule_message']  = "Your appointment has been rescheduled";
...
$lang['2_way_enabled'] = "To ensure your data safety, MedSign is enable with 2-factor authentication";
$lang['bill_added'] = "Bill added/updated succesfully";
$lang['bill_deleted'] = "Bill deleted succesfully";
$lang['price_mismatch'] = "Calculate price mismatch";
$lang['record_share'] = "Record shared succesfully";
$lang['kco_exists'] = "K/C/O already exists";
...
$lang['invoice_details_updated'] = "invoice details updated successfully";
$lang['survey_submitted'] = "Survey details submitted successfully";
$lang['survey_already_submitted'] = "You had already submitted survey details.";
$lang['survey_invalid_log_type'] = "Invalid log type";

$lang['patient_book_appointment'] = "%s is the OTP for booking appointment with %s at %s. Please share this OTP with doctor to confirm appointment";
$lang['wa_template_34_patient_book_appointment'] = "%s is the OTP for booking appointment with %s at %s. Please share this OTP with doctor to confirm appointment";
$lang['patient_not_found'] = "Invalid login credentials please try again";
$lang['invalid_import_file_id'] = "Invalid import file id";
$lang['missing_import_file'] = "Missing import file";
$lang['zip_file_not_open'] = "System cann't extract zip file";
$lang['invalid_file'] = "Invalid file";
$lang['doctor_import_file'] = "File uploaded successfully";
...
$lang['invalid_sub_plan'] = "Invalid subscription plan";
$lang['order_error'] = "Unable to create payment order";
$lang['payment_error'] = "Unable to capture payment";
$lang['payment_success'] = "Your payment has been done successfully.";
$lang['subscription_expired_message'] = "Your subscription plan is expired. Please contact MedSign support team.";

$lang['promo_code_success'] = "Promo code applied successfully";
$lang['promo_code_invalid'] = "Invalid promo code";
$lang['promo_code_used'] = "You have already used this promo code";
$lang['refer_patient_rx_otp'] = "%s is the OTP for accessing your MedSign account valid for 30 min. Please do not share it with anyone.";
$lang['no_whatsapp_credit'] = "You don't have enough Whatsapp credit on your account. Please contact support.";
$lang['no_sms_credit'] = "You don't have enough SMS credit on your account. Please contact support.";
$lang['diet_instruction_already_exists'] = "Instruction already exists";
$lang['diet_instruction_added'] = "Instruction added successfully";
$lang['diet_instruction_deleted'] = "Instruction deleted successfully";
$lang['diet_instruction_updated'] = "Instruction updated successfully";
$lang['health_advice_assigned'] = "Health advice assigned successfully";
$lang['health_advice_already_assigned'] = "Health advice already assigned";
$lang['payment_mode_added'] = "Payment mode added successfully";
$lang['payment_mode_deleted'] = "Payment mode deleted successfully";
$lang['payment_mode_updated'] = "Payment mode updated successfully";
...
$lang['tele_consultation_fees_error'] = "You need to add the Tele-Consultation charge on the Settings -> Clinic Details page. To start Tele-Consultation appointment.";
$lang['payment_mode_error'] = "You need to add your UPI ID to receive tele-consultation fee from setting -> Tele-consultation Payment page.";
$lang['appointment_type_update'] = "Tele-consultation prescription saved.";
$lang['patient_group_added'] = "Patient group added successfully";
$lang['patient_group_deleted'] = "Patient group deleted successfully";
$lang['patient_group_updated'] = "Patient group updated successfully";
$lang['patient_communications_sms'] = "Patient communication message sent successfully";
$lang['no_enough_sms_credit'] = "You have no enough sms credits for sent message";
$lang['test_sms_send_success'] = "Test sms sent successfully";
$lang['promotional_sms_template'] = "Dear %s,
 %s";
$lang['characters_limit_over'] = "Your message characters limit is over";
$lang['video_call_ended'] = "Your teleconsultation call is ended. Credit minutes balance left in your account is %s minutes.";
$lang['video_call_minute_error'] = "You have no enough video call minutes. You need to buy the video call minutes.";
...
Link: %s";
$lang['video_call_ended_message'] = "This appointment call is already ended";
$lang['investigation_already_exists'] = "Investigation already exists";
$lang['investigation_added'] = "Investigation added successfully";
$lang['investigation_deleted'] = "Investigation deleted successfully";
$lang['investigation_updated'] = "Investigation updated successfully";
$lang['uas7_added'] = "UAS7 data saved successfully";
...
$lang['wa_template_29_appoint_cancel_patient'] = "Dear %s, Your appointment with %s at %s on %s is cancelled. Please rebook your appointment. Team MedSign!\nVisit- %s\nEmail- %s";
$lang['wa_template_29_appoint_reschedule_patient']  = "Dear %s, Your appointment with %s at %s is rescheduled. The new appointment date and time is %s. Team MedSign!\nVisit- %s\nEmail- %s";
...
$lang['caretaker_varification_otp'] = "%s is the OTP for accessing your MedSign account valid for 30 min. Please do not share it with anyone.";
$lang['invalid_caretaker_details'] = "Please enter caretaker details";
$lang['wa_template_30_otp'] = "%s is the OTP for accessing your MedSign account valid for 30 min. Please do not share it with anyone.";
$lang['invalid_language'] = "Invalid language";
$lang['translate_success'] = "Translate success";
$lang['caregiver_email_same'] = "Patient and caregiver email is same";
$lang['caregiver_mobile_same'] = "Patient and caregiver mobile number is same";
$lang['caregiver_register_email_exist'] = "This caregiver email is already registered with us";
...
$lang['lang_duplicate_error'] = "Duplicate languages selected";
$lang['share_link_added'] = "Share link added successfully";
$lang['share_link_deleted'] = "Share link deleted successfully";
$lang['share_qrcode_link'] = "Registration link Shared successfully";
$lang['share_link_updated'] = "Share link updated successfully";
$lang['patient_reg_sms'] = "Hello %s, Welcome to 'MedSign'-Digital health platform. You have been successfully registered on MedSign.
Avail the unique benefits of MedSign features for FREE like:
1. Create your health profile.
2. Save and View health records.
3. Enter and track vital health parameters.
4. Manage appointments.
5. Assign Caregiver.

For help and support: %s
Wishing you Good Health!
Thanks and Regards,
Team MedSign!";
$lang['patient_register_msg_49'] = "Hello %s, Welcome to 'MedSign'-Digital health platform. You have been successfully registered on MedSign.\nAvail the unique benefits of MedSign features for FREE like:\n1. Create your health profile.\n2. Save and View health records.\n3. Enter and track vital health parameters.\n4. Manage appointments.\n5. Assign Caregiver.\n\nFor help and support: %s\nWishing you Good Health!\nThanks and Regards,\nTeam MedSign!";
$lang['promoting_medsign_sms'] = "Dear %s, Create your MedSign digital health account by clicking here %s. Complete your profile,book/ view appointments,prescriptions,upload medical reports, enter/ track vital health parameters. Wishing you good health! Team MedSign! Visit- %s Email- %s";
$lang['promoting_wa_medsign_sms'] = "Dear %s, Create your MedSign digital health account by clicking here %s. Complete your profile,book/ view appointments,prescriptions,upload medical reports, enter/ track vital health parameters.\nWishing you good health!\nTeam MedSign!\nVisit- %s\nEmail- %s";