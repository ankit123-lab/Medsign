...
/*
  ...
  |
 */
$config['rest_valid_logins'] = ['medeasy' => 'api@medeasy'];
...
/*
  ...
  |
 */
$config['rest_enable_logging'] = ENABLE_API_LOG;
...
/*
  |--------------------------------------------------------------------------
  | Except Authentication for api
  |--------------------------------------------------------------------------
  | e.g. $config['allowed_origins'] = ['class/method']
  |
 */
$config['except_uris'] = ["Common/index"];
