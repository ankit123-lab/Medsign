...
var DEFAULT_URL = '<?php if(isset($_GET['charting_url'])){ echo urldecode(base64_decode($_GET['charting_url'])); }else{ echo ''; } ?>';
...
PDFJS.imageResourcesPath = PREVIEW_URL + 'images/';
  PDFJS.workerSrc = PREVIEW_URL + 'build/pdf.worker.js';
  PDFJS.cMapUrl = PREVIEW_URL + 'web/cmaps/';
